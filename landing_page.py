...
class LandingPage:
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'image/alien0_{n}.png'), 0, 0.25) for n in range(2)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'image/alien1_{n}.png'), 0, 0.25) for n in range(2)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'image/alien2_{n}.png'), 0, 0.25) for n in range(2)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'image/alienship1_{n}.png'), 0, 0.7) for n in range(2)]

...
class Ship(Sprite):
    exploding_images = [pg.image.load(f'image/exp{n}.png') for n in range(5)]
    images = [pg.image.load(f'image/ship.bmp') for n in range(1)]
    ...
    def __init__(self, game):
        ...
        self.image = pg.image.load('image/ship.bmp')
